...
# =============================================================================
# RC-EQUIVARIANT CONFIGURATION (ZOH)
# =============================================================================
...
RC_CONFIG = HyenaFineTuneConfig(
    ...
    d_conv=4,
    expand=2,
    mode="zoh",               # ZOH discretization (Zero-Order Hold)
    ...
    # Directories (ZOH-specific)
    checkpoint_dir="./checkpoints/rc_equivariant_20k_zoh",
    results_dir="./results/rc_equivariant_20k_zoh",
...
def train_with_rc_equivariance(
    ...
    """
    print("\n" + "="*70)
    print("RC-EQUIVARIANT TRAINING (ZOH)")
    print("="*70)
...
def main():
    """Main training function with RC equivariance (ZOH)."""
    print("\n" + "="*70)
    print("RC-EQUIVARIANT ZOH-MAMBA TRAINING FOR HG38")
    print("="*70)
    print("\nConfiguration:")
    print(f"  Model: {RC_CONFIG.d_model}d × {RC_CONFIG.n_layers} layers")
    print(f"  Mode: {RC_CONFIG.mode} (ZOH discretization)")
    ...
    # Create model
    print("\nCreating hybrid model (HyenaDNA + ZOH-Mamba)...")
    ...
    # Train
    print("="*70)
    print("STARTING RC-EQUIVARIANT TRAINING (ZOH)")
    print("="*70)
    ...
    try:
        ...
        with open(summary_path, 'w') as f:
            f.write("RC-Equivariant ZOH-Mamba Training Summary\n")
            f.write("=" * 50 + "\n\n")
